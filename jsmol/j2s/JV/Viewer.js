...
return (type == null ? null : this.readCifData (null, rdr, "cif2".equals (type.toLowerCase ())));
}, "~S,~S");
Clazz.defineMethod (c$, "readCifData", 
function (fileName, rdrOrStringData, isCif2) {
...
return JU.Rdr.readCifData (J.api.Interface.getInterface ((isCif2 ? "J.adapter.readers.cif.Cif2DataParser" : "JU.CifDataParser"), this, "script"), rdr);
}, "~S,~O,~B");
