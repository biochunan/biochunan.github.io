...
var box = sg.params.boundingBox;
fileName = fileName.$replace ("0,0,0/0,0,0", box[0].x + "," + box[0].y + "," + box[0].z + "/" + box[1].x + "," + box[1].y + "," + box[1].z);
JU.Logger.info ("reading " + fileName);
...
this.dmean = this.getCifFloat ("_volume_data_3d_info_mean_source");
var rmsDeviation = this.getCifFloat ("_volume_data_3d_info_sigma_source");
